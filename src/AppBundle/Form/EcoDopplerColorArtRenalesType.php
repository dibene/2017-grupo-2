...
class EcoDopplerColorArtRenalesType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'AppBundle\Entity\EcoDopplerColorArtRenales'
        ));
    }
    ...
    {
        return 'appbundle_ecodopplercolorartrenales';
    }
